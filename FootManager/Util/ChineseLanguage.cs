...
namespace FootManager
{
    ...
    public class ChineseLanguage
    {
        ...
        {
            Localizer.Active = new XtraEditorsCN();
            GridLocalizer.Active = new XtraGridCN();
            BarLocalizer.Active = new XtraBarCN();
            BarLocalizer.Active.Customization = new XtraBarsCustomizationLocalizationCN();
            NavBarLocalizer.Active = new XtraNavBarCN();
            PreviewLocalizer.Active = new XtraPrintingCN();
            ReportLocalizer.Active = new XtraReportsCN();
            TreeListLocalizer.Active = new XtraTreeListCN();
            VGridLocalizer.Active = new XtraVerticalGridCN();
        }
    }
    ...
    /// XtraEditor
    /// </summary>
    public class XtraEditorsCN : Localizer
    {
        /// <summary>
        /// 重写语言属性
        /// </summary>
    ...
    /// 网格控件
    /// </summary>
    public class XtraGridCN : GridLocalizer
    {
        /// <summary>
        /// 重写语言属性
        /// </summary>
        ...
        public override string GetLocalizedString(GridStringId id)
        {
            switch (id)
            {
                ...
                case GridStringId.MenuColumnBestFitAllColumns: return "显示每列完整内容";
                ...
                case GridStringId.MenuColumnFilterEditor: return "过滤器编辑器";
                case GridStringId.MenuColumnFindFilterShow: return "显示查找面板";
                case GridStringId.MenuColumnAutoFilterRowShow: return "显示自动筛选行";
                case GridStringId.MenuColumnGroupBox: return "分组区";
                case GridStringId.MenuGroupPanelShow: return "分组区";
                ...
                case GridStringId.LayoutViewLabelAllowFieldHotTracking: return "显示所有";
            }
    ...
    /// <summary>
    /// BarsCustomizationLocalization
    /// </summary>
    public class XtraBarsCustomizationLocalizationCN : CustomizationControl
    {
        /// <summary>
        /// 是否已经释放
        /// </summary>
        ...
        /// 构造函数
        /// </summary>
        public XtraBarsCustomizationLocalizationCN()
        {
    ...
    /// XtraTreeList
    /// </summary>
    public class XtraTreeListCN : TreeListLocalizer
    {
        /// <summary>
        /// 重写语言属性
        /// </summary>
    ...
    /// XtraVerticalGrid
    /// </summary>
    public class XtraVerticalGridCN : VGridLocalizer
    {
        /// <summary>
        /// 重写语言属性
        /// </summary>
